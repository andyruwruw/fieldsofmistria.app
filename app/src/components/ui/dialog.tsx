  ...
  ref,
	...
	<DialogPortal>
		...
		<DialogPrimitive.Content
			...
			<DialogPrimitive.Close className='absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-muted data-[state=open]:text-foreground-muted'>
...
>(({
  ...
  ref,
	...
	<DialogPrimitive.Description
		ref={ref}
		className={combineNames('text-sm text-foreground-muted', className)}
		{...props} />
));
