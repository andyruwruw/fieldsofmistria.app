 ...
 */
export interface ArtifactsHeaderProps {
  /**
   * The current progression of the artifact tracking.
   */
  progression?: number;
}
 ...
 */
export const ArtifactsHeader = ({ progression = 0 }: ArtifactsHeaderProps): ReactElement => {
  return (
    <>
              ...
              <div className='grid grid-cols-1 grid-rows-2 gap-4 xl:grid-cols-3 2xl:grid-cols-3'>
                <Card
                  ...
                  <div className='flex flex-col items-center p-4'>
                    ...
                    <PercentageIndicator
                      percentage={Math.floor(progression * 100)}
