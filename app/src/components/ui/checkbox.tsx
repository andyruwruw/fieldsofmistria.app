...
/**
 * Checkbox component that allows users to select or deselect options.
 * It can be used in forms or settings where multiple choices are available.
 */
...
>(({
  ...
  ref,
	...
	<CheckboxPrimitive.Root
		...
		{...props}>
		<CheckboxPrimitive.Indicator className={combineNames('flex items-center justify-center text-current')}>
...
/**
 * Checkbox display name for debugging purposes.
 */
